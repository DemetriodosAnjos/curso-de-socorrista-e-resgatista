/* ==========================================================
   IMPORTAÇÃO SIDEBAR
   ========================================================== */
import { initSidebar } from "./data/sidebar.js";

/* ==========================================================
   IMPORTAÇÕES DE MÓDULOS DE CONTEÚDO
   ========================================================== */
...
/* ==========================================================
   INICIALIZA SIDEBAR NO DOM
   ========================================================== */
document.addEventListener("DOMContentLoaded", () => {
  // Inicializa a sidebar passando a função de carregar matérias
  initSidebar((key) => {
    carregarMateria(key);

    // Se estiver em tela mobile, fecha a gaveta
